        ...
        <div className="vj-pf-exp-card before:text-amber-700 dark:before:text-amber-500">
          <div className="exp-info bg-gray-200 dark:bg-zinc-800 border border-[#c5c5c5] dark:border-zinc-600">
            <h3 className="title next-company-icon text-amber-700 dark:text-amber-500 font-bold">
              {t("Wherever the wind takes me...")}
            </h3>
            <p className="text-justify text-zinc-700 dark:text-zinc-400">
              {t("The future is fluid. Each act, each decision, and each development creates new possibilities and eliminates others. Be not afraid of discomfort. If you can't put yourself in a situation where you are uncomfortable, then you will never grow. You will never change. You'll never learn. so We only have control over the choice; we have no control over what is happening.")}
            </p>
          </div>
        </div>
      </div>
