...
const Contactpage: React.FC = () => {
  ...
  return (
    <section id="contact-section" className="py-16 bg-gray-100 dark:bg-transparent vj-pf-section contact">
          ...
          <div className="lg:col-span-5 col-span-12 gap-8">
            <div className="bg-white dark:bg-[#1d1e22] dark:text-gray-400 px-2 py-4 sm:px-8 sm:py-8 rounded-lg shadow-lg w-full info">
              ...
              <div className="flex items-center vj-pf-contact-details">
                ...
                <h4 className="text-lg font-bold text-amber-600 dark:text-amber-500">Email:</h4>
              </div>
              <p className="text-gray-700 dark:text-gray-400">
              ...
              >
                ...
                <h4 className="text-lg font-bold text-amber-600 dark:text-amber-500">Call:</h4>
              </div>
          ...
          <div className="lg:col-span-7 col-span-12 gap-8">
            ...
            >
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="w-full bg-amber-600 text-white px-4 py-2 rounded-md hover:bg-amber-700 transition"
                >
                  Send Message
                </button>
              </div>
