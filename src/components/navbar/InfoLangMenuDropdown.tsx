...
const InfoLangMenuDropdown: React.FC = () => {
  ...
  return (
    <div
      ...
      className="lg:relative inline-block text-left group"
    >
      <button
        aria-label="menu-button"
        type="button"
        onClick={() => setIsLangDropdown(!isLangDropdown)}
        className="inline-flex justify-center w-full px-2 py-2 text-sm font-medium outline-none bg-transparent fill-black dark:fill-white text-black dark:text-white dark:hover:text-white/75 border-gray-300 rounded-md focus:outline-none focus:ring-0"
      >
        <svg
          viewBox="0 0 25 25"
          fill="currentColor"
...
export default InfoLangMenuDropdown;
