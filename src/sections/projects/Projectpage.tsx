                ...
                <article className="w-full h-full bg-transparent hover:bg-white dark:hover:bg-[#1d1e22] rounded-lg hover:shadow-lg overflow-hidden">
                  ...
                  <div className="flex flex-col gap-1 p-6">
                    ...
                    <span className="block text-gray-600 dark:text-gray-200 mt-2">
                      <button
                        type="button"
                        className="px-3 py-1 text-xs font-bold text-center inline-flex items-center text-blue-700 bg-blue-100 dark:text-blue-200 dark:bg-blue-900/50 rounded-lg focus:ring-0 focus:outline-none transition-colors"
                      >
                        {item.type === "Personal" && (
